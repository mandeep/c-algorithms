...
def test_binary_search():
    ...
    assert binary_search.binary_search([1, 2, 3, 4], 2) == 1
    assert binary_search.binary_search([3.5, 4.5, 6.5, 7.5], 6.5) == 2
    assert binary_search.binary_search(list(range(1, 100000)), 3496) == 3495
